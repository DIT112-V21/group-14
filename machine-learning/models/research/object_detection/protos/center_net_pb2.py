...
_CENTERNET = _descriptor.Descriptor(
  ...
  nested_types=[_CENTERNET_PREDICTIONHEADPARAMS, _CENTERNET_OBJECTDETECTION, _CENTERNET_OBJECTCENTERPARAMS, _CENTERNET_KEYPOINTESTIMATION, _CENTERNET_MASKESTIMATION, _CENTERNET_DENSEPOSEESTIMATION, _CENTERNET_TRACKESTIMATION, _CENTERNET_TEMPORALOFFSETESTIMATION, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,

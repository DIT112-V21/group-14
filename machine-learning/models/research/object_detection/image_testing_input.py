...
TEST_IMAGE_PATHS = [os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpg'.format(i)) for i in range(1, 10)]  # adjust range for # of images in folder
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
            ...
            plt.savefig("../../../images/output/detection_output{}.jpg".format(i))  # create an outputs folder for the images to be saved
